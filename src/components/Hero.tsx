...
function Hero() {
  return (
    <div
      className="relative flex flex-col items-center justify-center text-center min-h-screen w-full px-6 md:px-12 py-20 space-y-8 overflow-hidden"
      id="hero"
    >
      ...
      <div className="relative flex flex-col items-center justify-center space-y-8">
        <h1 className="text-5xl font-bold sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-white">
          Your Ideas,  
          Our Innovation
        </h1>
        ...
        <div className="flex items-center justify-center gap-6">
          <a href="https://cal.com/isonikrish/book" target="_blank" rel="noopener noreferrer">
            <Button className="px-8 py-4 text-md font-semibold rounded-md flex items-center space-x-1">
